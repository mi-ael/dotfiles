...
export def main [
  ...
  echo "task is a command-line task manager. It can be used to queue tasks and execute them sequentially or in parallel (using pueue)."
  echo ""
  echo "Usage:"
  echo "  task <command> [options]"
  echo ""
  echo "Available commands: "
  echo "  spawn remove switch stash queue start restart pause kill send edit group status log wait clean shutdown set-parallel-limit"
  echo "For more information about a specific command, run `task <command> --help`."
  echo ""
  echo "For more information about pueue, run `pueue --help`."
